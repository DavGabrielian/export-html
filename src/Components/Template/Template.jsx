                    ...
                    <div className="temp-container">
                        ...
                        <div className="temp-block">
                            <div className="temp-items" onChange={e => setSelectedTemp(e.target.value)}>
                                <input id="radio_1" className="radio isHidden" name="radio_a" type="radio"
                                       value="left"/>
                                ...
                                <input id="radio_2" className="radio isHidden" name="radio_a" type="radio"
                                       value="center"/>
                                ...
                                <input id="radio_3" className="radio isHidden" name="radio_a" type="radio"
                                       value="right"/>
                        ...
                        <div className="temp-container">
                            ...
                            <div className="temp-block">
                                <div className="temp-items" onChange={e => setSelectedTemp(e.target.value)}>
                                    ...
                                    <label htmlFor="radio_1" className="label">
                                        <div>
                                            <img src="/SVG/page-layout3.svg" width="123" alt="preview"/>
                                            <span>Left align</span>
                                        </div>
                                    </label>
                                    ...
                                    <label htmlFor="radio_3" className="label">
                                        <div value="right">
                                            <img src="/SVG/page-layout1.svg" width="147" alt="preview"/>
                                            <span>Right align</span>
                                        </div>
                                    </label>
                                </div>
